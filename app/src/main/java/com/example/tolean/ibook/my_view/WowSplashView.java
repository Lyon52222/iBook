...
import com.example.tolean.ibook.utils.SvgPathParser;

/**
 * Created by Tolean on 2017/9/15.
 */
...
public class WowSplashView extends View {
    ...
    private String mTitle = getResources().getString(R.string.start_animation_title);
...
//        setBackgroundColor(context.getResources().getColor(R.color.brown));
        setBackgroundColor(ThemUtil.getThemColor());
